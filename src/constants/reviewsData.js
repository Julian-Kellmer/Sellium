export const reviewsData = [
  ...
  },
  {
    id: 6,
    name: 'Lucas Garzon',
    role: 'Dueño de Edición Limitada',
    text: 'Gracias al nuevo sistema de fidelización nuestro ticket promedio aumento un 40% nos encontramos con CPC mas bajos aumentando el volumen de venta. Segmentando nuestra audiencia comunicamos sobre productos importados nuevos y pudimos quebrar el stock.',
    image: './EdicionLimitada.png',
  },
  {
    id: 7,
    name: 'Nikanor Lang',
